...
public class JsonDownloadAdapter implements DownloadAdapter {
	...
	@Override
	public void run(List<ResponseDTO> result, HttpServletResponse response, String stateAbbreviation)
		...
		try {
			...
			response.setHeader("Content-Disposition",
					String.format("attachment; filename=\"%s\"", this.contentDisposition()));
